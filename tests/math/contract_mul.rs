...
mod contract_mul_tests {
    ...
    #[test]
    fn invalid_dot() {
        let t1 = Tensor::new(&shape![1, 2, 3], (0..6).collect()).unwrap();

        let t2 = Tensor::new(&shape![2, 1, 3], (0..6).collect()).unwrap();
        ...
        let m1 = Matrix::new(3, 2, (0..6).collect()).unwrap();
        let m2 = Matrix::new(2, 3, (0..6).collect()).unwrap();
