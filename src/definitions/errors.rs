...
pub enum TensorErrors {
    ...
    IndexOutOfBounds { index: usize, axis: usize, length: usize },
    ...
    SliceIndicesOutOfBounds { axis: usize, length: usize, start: usize, end: usize },
    #[error("Slice shape {slice_shape} incompatible with tensor shape {tensor_shape}")]
    SliceIncompatibleShape { slice_shape: Shape, tensor_shape: Shape },
    ...
    InvalidNonEmptyInterval { min: f64, max: f64 },
